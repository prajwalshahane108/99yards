...
import HelpCon2 from "../components/HelpCon2"; // Importing the HelpCon2 component
// Custom theme
         ...
         >
          <Container maxWidth="lg">
            <Grid
              ...
              spacing={4}
              sx={{
                justifyContent: "center", // This will center the grid items
              }}
            >
